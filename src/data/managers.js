...
export const managers = [
{
 ...
 profileText:`Sebastian steht aktuell bei 63,80 Mio. € Kaderwert. Entscheidend für Rang eins ist aber die Mischung: Nusa, Gnabry, Stiller und Rômulo liefern Spitze, dahinter gibt es ungewöhnlich viel brauchbare Tiefe. ${seasonNote}`,
 runningGag:'„Macht ihr mal … :)“ klingt bei Sebastian traditionell weniger nach Rückzug als nach Drohung.', rank:2, value:'63,80 Mio. €', grade:'1,4', verdict:'Favorit', trend:'↑', trendText:'stärkster Gesamtmix', lastTransfer:'Nebel · 3,65 Mio. €', chance:'sehr hoch', status:'Die Redaktion sieht aktuell den komplettesten Kader der Liga.',
 players:['Nusa','Rômulo','Gnabry','Sylla','Marino','Stiller','Nebel','Nartey','Stöger','Krauß','Vermeeren','Poreba','Obermair','Pieper','Caci','Rohr','Schwäbe'], keys:['Nusa','Stiller','Gnabry'], key:'Nusa',
...
},
{
 ...
 profileText:`Luca steht bei 64,52 Mio. € und übernimmt im Redaktionsranking Rang eins. Kimmich, Moreira, Ache und Ryerson liefern Qualität; zusätzlich hat Luca mit schnellen Trades wie Kauã Santos aktiv Kapital geschaffen. ${seasonNote}`,
 runningGag:'Der dritte Platz verfolgt ihn seit Jahren. Dieses Mal will Luca offenbar gar nicht erst in seine Nähe.', rank:1, value:'64,52 Mio. €', grade:'1,5', verdict:'Titelkader', trend:'→', trendText:'weiter ganz oben', lastTransfer:'Karius · 2,73 Mio. €', chance:'sehr hoch', status:'Kimmich als Anker, dazu Qualität in fast jedem Mannschaftsteil.',
 players:['Ache','Hack','Stange','Silas','Moreira','Kimmich','Seiwald','Remberg','Aouchiche','Ryerson','Querfeld','Kübler','Zetterer','Karius'], keys:['Kimmich','Moreira','Ryerson'], key:'Kimmich',
...
},
{
 ...
 profileText:`Henning kommt auf 56,94 Mio. €. Rang vier bleibt ein starkes Qualitätsurteil: Guirassy und Burkardt bilden das stärkste Sturmduo der Liga, Nmecha, Prömel und Karaman geben dem Mittelfeld Substanz. ${seasonNote}`,
 runningGag:'Wenn Henning etwas ankündigt, folgt entweder ein Transfer, eine Grundsatzdebatte oder Leffe.', rank:4, value:'56,94 Mio. €', grade:'1,7', verdict:'Luxussturm', trend:'→', trendText:'starke Achse', lastTransfer:'Kaderstand 20.08.', chance:'hoch', status:'Weniger Breite als die Top zwei, dafür enorme Qualität an der Spitze.',
...
},
{
 ...
 profileText:`Gregor steht bei 51,79 Mio. €. Trotz Rang acht im neuen Ranking ist sein Kaderwert nur Mittel zum Zweck: Schick, Kramarić, Grifo, Pavlović und Schlotterbeck sind eine erstaunlich erwachsene Achse. ${seasonNote}`,
 runningGag:'Der Fußball-Laie besitzt inzwischen auffällig viele Spieler, die Fußball können.', rank:8, value:'51,79 Mio. €', grade:'1,8', verdict:'Dark Horse', trend:'↑', trendText:'verdächtig komplett', lastTransfer:'Dompé · 0,88 Mio. €', chance:'hoch', status:'Viele etablierte Punktelieferanten statt reiner Marktwertfantasie.',
...
},
{
 ...
 profileText:`José steht mit Harry Kane bei 53,42 Mio. € Kaderwert. Der Königstransfer verändert alles: Kane ist der beste Einzelspieler dieses Kaders und vermutlich der mächtigste Comunio-Stürmer der Liga. Tietz, Suzuki, Mohya und Ginter bilden das Gerüst dahinter. ${seasonNote}`,
 runningGag:'Er erklärt den Fußball vollständig. Diesmal erklärt Harry Kane den anderen Managern den Unterschied.', rank:5, value:'53,42 Mio. €', grade:'1,9', verdict:'Kane-Faktor', trend:'↑', trendText:'Königstransfer', lastTransfer:'Kane · 26,30 Mio. €', chance:'hoch', status:'Der beste Einzeltransfer der Vorbereitung katapultiert José in die erweiterte Spitzengruppe.',
 players:['Kane','Tietz','Suzuki','Banzuzi','Mohya','Ginter','Deman','Jaquez','Lochoshvili','Kobel','Meyer'], keys:['Kane','Tietz','Ginter'], key:'Kane',
...
},
{
 ...
 profileText:`Matthias besitzt einen 63,19-Mio.-€-Kader mit enormer Breite. Uzun, Karl, Onyedika, Fabio Silva und Ansah haben Qualität und Fantasie – die Redaktion sieht aber mehr offene Wetten als bei den fünf Teams vor ihm. ${seasonNote}`,
 runningGag:'Er kennt das nächste Talent oft früher als die Verkaufsfunktion.', rank:6, value:'63,19 Mio. €', grade:'2,0', verdict:'Upside-Kader', trend:'→', trendText:'viel Potenzial', lastTransfer:'Finkgräfe · 0,59 Mio. €', chance:'gut', status:'Hohe Decke, aber mehr Projektion und Konkurrenzkämpfe als bei der Spitze.',
 players:['Ansah','Fábio Silva','Harder','Dinkçi','Topp','Milošević','Campbell','Karl','Sambi Lokonga','Uzun','Darvich','Kaba','Onyedika','Badé','Castro-Montes','Rothe','Belocian','Günter','Finkgräfe','Boey','Malatini','Herold','Backhaus','Blaswich'], keys:['Uzun','Karl','Onyedika'], key:'Uzun',
...
},
{
 ...
 profileText:`Tomi steht bei 64,23 Mio. € und springt im Redaktionsranking auf Rang drei. Demirović, Doan, Brown, Diks und Quansah sind ein solides Fundament. Sein öffentliches Urteil zum neuen Comunio-Design fällt deutlich schlechter aus als das Urteil der Redaktion über seinen Kader. ${seasonNote}`,
 runningGag:'„Pleite und Ahnungslos“ ist ab sofort entweder Zustandsbeschreibung oder neue Vereinsphilosophie.', rank:3, value:'64,23 Mio. €', grade:'2,2', verdict:'Solide Substanz', trend:'→', trendText:'besser als die Laune', lastTransfer:'Kaderstand aktuell', chance:'gut', status:'Breit und ordentlich, aber weniger echte Premiumspitze als die Konkurrenz davor.',
...
},
{
 ...
 profileText:`Wassilios kommt auf 45,88 Mio. €. Olise ist der klare Superstar, dahinter folgen Reitz, Gadou, Chaïbi und Sander. Für die Redaktion ist das weiterhin eine starke Ein-Mann-Spitze mit ordentlichem Unterbau. ${seasonNote}`,
 runningGag:'Ohne Wassili findet die IWF weder Unterkunft noch Richtung.', rank:7, value:'45,88 Mio. €', grade:'2,5', verdict:'Olise-Wette', trend:'→', trendText:'starabhängig', lastTransfer:'Kaderstand aktuell', chance:'offen', status:'Ein Superstar hält den Kader gefährlich; die zweite Premiumebene fehlt.',
...
},
{
 ...
 profileText:`Uwe steht bei 35,58 Mio. €. Kofane, Orbán, Lee, Futkeu und Nicolas ergeben eine brauchbare Basis. Wie immer entscheidet aber nicht nur der Kader, sondern die Frage, wie oft der Manager ihn tatsächlich anschaut. ${seasonNote}`,
 runningGag:'Niemand weiß, ob Uwe schläft, plant oder längst den nächsten wilden Transfer vorbereitet.', rank:10, value:'35,58 Mio. €', grade:'2,9', verdict:'Wildcard', trend:'→', trendText:'unberechenbar', lastTransfer:'Kaderstand aktuell', chance:'Außenseiter', status:'Ein paar gute Bausteine, insgesamt aber klar weniger Qualität als die obere Hälfte.',
...
},
{
 ...
 profileText:`Jan steht bei 35,74 Mio. €. Baku, Chema Andrés, Tillman, Bülter und Flekken sind brauchbar, aber der Kader ist klein und ohne echten Premiumspieler. Besonders bitter: Kane, sein Star der Vorsaison, landet ausgerechnet bei José. ${seasonNote}`,
 runningGag:'Bangkok, Bayern und Bilderrätsel – und jetzt auch noch Kane-Liebeskummer.', rank:9, value:'35,74 Mio. €', grade:'3,0', verdict:'Noch Baustelle', trend:'↓', trendText:'Kane verpasst', lastTransfer:'Höler · 2,55 Mio. €', chance:'Außenseiter', status:'Gute Einzelteile, aber aktuell der dünnste Qualitätskader der Liga.',
 players:['Bülter','Höler','Burke','Moerstedt','Tillman','Martel','Y. Engelhardt','Chema Andrés','Baku','Scally','Mwene','Flekken'], keys:['Baku','Tillman','Chema Andrés'], key:'Baku',
