export const managers = [
  {
    ...
    ingo:'Henning beginnt engagiert und diesmal wirkt der Kader nicht nur aktiv, sondern tatsächlich geplant. Das könnte seine beste Saison werden.',
    werner:'Die Achse Baumann – Widmer – Nmecha – Prömel ist belastbar. Für Platz eins fehlt derzeit noch ein verlässlicher Stürmer.',
    franz:'HENNING GREIFT AN! Aus dem ewigen Projektmanager wird plötzlich ein Meisterjäger.'
  },
  {
    name:'Jose', team:'Jose Mulhinho', profileTitle:'Der Raumdeuter', claim:'Der Fußballromantiker mit Doktortitel.', image:'/images/managers/jose.png', profileText:'Spielleiter, einziger Doktor der Runde und überzeugter Fußballromantiker. Jose spielte selbst jahrelang Fußball und war der Raumdeuter seines Teams – dieses Gespür für freie Räume prägt bis heute seinen Kaderbau.', runningGag:'Er erklärt den Fußball gern vollständig. Sebastian nimmt ihm trotzdem regelmäßig die Trophäe ab.', rank:2, value:'21,96 Mio.', grade:'1,8', verdict:'Top 3',
    ...
    ingo:'Jose baut keine Mannschaft für Schlagzeilen, sondern für 34 Spieltage. Genau deshalb ist er jedes Jahr gefährlich.',
    werner:'Der Kader ist strukturell sauber. Zwei Torhüter, vier Verteidiger, sechs Mittelfeldspieler, drei Stürmer. Wenig Verschwendung, viel Ordnung.',
    franz:'JOSE MAUERT SICH ZUM TITEL! Brown kostet allein mehr als mancher kompletter Sturm.'
  },
  {
    name:'Uwe', team:'uje', profileTitle:'Der X-Faktor', claim:'Zwischen Genie und Tabellenkeller ist alles möglich.', image:'/images/managers/uwe.png', profileText:'Uwe ist der Unberechenbare der IWF. Er kennt den Fußball, kann jede Saison entscheidend prägen und genauso gut wochenlang wirken, als hätte er die App verlegt.', runningGag:'Niemand weiß, ob Uwe schläft, plant oder längst den entscheidenden Coup vorbereitet.', rank:3, value:'27,81 Mio.', grade:'2,0', verdict:'Wildcard',
    ...
    ingo:'Bei Uwe liegt das große Rätsel nie auf dem Platz, sondern im Kalender. Fußballwissen ist da. Die Frage ist, ob er es nutzt.',
    werner:'Rein sportlich gehört dieser Kader in die obere Tabellenhälfte. Organisatorisch bleibt die Prognose mit einem erheblichen Unsicherheitsfaktor versehen.',
    franz:'27,81 MILLIONEN UND TROTZDEM NICHT ERREICHBAR! Uwe besitzt das teuerste Funkloch der Liga.'
  },
  {
    name:'Tomi', team:'VADDERN 79', profileTitle:'Der Ausredenkönig', claim:'Auf Reisen selten dabei, in Erklärungen Weltklasse.', image:'/images/managers/tomi.png', profileText:'Tomi setzt gern auf große Namen und große Ansagen. Bei den jährlichen IWF-Reisen ist er dagegen traditionell mit einer neuen Ausrede beschäftigt.', runningGag:'Für den Transfermarkt reicht die Zeit immer. Für die IWF-Reise leider nie.', rank:4, value:'20,87 Mio.', grade:'2,1', verdict:'Top-5-Kandidat',
    ...
    ingo:'Tomi liebt Namen. Diesmal hat er neben Namen aber auch Substanz gekauft. Das macht ihn gefährlicher als in mancher Vorsaison.',
    werner:'Doan trägt 26 Prozent des gesamten Kaderwerts. Das ist sportlich nachvollziehbar, erhöht aber das Klumpenrisiko.',
    franz:'DOAN ODER DOWN! Tomis Saison hängt an einem Mann – und der weiß hoffentlich nichts davon.'
  },
  {
    name:'Luca', team:'Luca Costantini', profileTitle:'Der kreative Italo', claim:'Ideen statt Brechstange – Fußball mit Stil.', image:'/images/managers/luca.png', profileText:'Luca gewann den ersten Titel der IWF-Geschichte und ist damit für immer Teil der Gründungsmythologie. Kreativ, engagiert und mit italienischem Hang zu großen Fußballgeschichten.', runningGag:'Der dritte Platz verfolgt ihn mit einer Treue, die manchem Spieler gut stehen würde.', rank:5, value:'22,11 Mio.', grade:'2,2', verdict:'Geheimfavorit',
    ...
    ingo:'Der erste IWF-Meister hat wieder eine Mannschaft mit klarer Handschrift. Vorne Mut, hinten Stabilität – dazwischen noch eine Lücke.',
    werner:'Sturm und Abwehr sind überdurchschnittlich. Das Mittelfeld liegt im Ligavergleich deutlich zurück. Die Transferpriorität ist eindeutig.',
    franz:'NUSA-MANIA! Luca hat vorne Champions League und in der Mitte noch Kreisliga-Vorbereitung.'
  },
  {
    name:'Matthias', team:'mazzephase', profileTitle:'Der Pumper', claim:'Muskelmasse, Lucky Shot und ein Herz für Underdogs.', image:'/images/managers/matthias.png', profileText:'Matze ist Vegetarier, Fitnessstudio-Stammgast und Liebhaber der Außenseiter. Er entdeckt Spieler, die sonst niemand kennt – manchmal sogar die Comunio-App erst danach.', runningGag:'Er kennt das nächste Talent oft früher als die Verkaufsfunktion.', rank:6, value:'21,53 Mio.', grade:'2,3', verdict:'Überraschungskandidat',
    ...
    ingo:'Matthias sieht Spieler, bevor sie Namen werden. Das kann brillant wirken – oder im Oktober wie ein missglücktes Scoutingseminar.',
    werner:'Hohe Varianz. Der Kader hat mehr Upside als Sicherheit. Für eine Meisterschaft ist die Trefferquote derzeit zu ungewiss.',
    franz:'WER SIND DIE ALLE? Matthias kauft schon wieder die Bundesliga von übermorgen.'
  },
  {
    name:'Jan', team:'Greifbramo', profileTitle:'Der Entertainer', claim:'Immer für eine Show gut – auch aus Bangkok.', image:'/images/managers/jan.png', profileText:'Jan lebt in Bangkok, liebt Entertainment und optimiert Systeme, Regeln und Transfers mit großer Ausdauer. 2028 wird die IWF-Reise für ihn zum Heimspiel.', runningGag:'Bei Bayern-Spielern und Regel-Lücken endet die thailändische Gelassenheit.', rank:7, value:'22,58 Mio.', grade:'2,5', verdict:'Solides Mittelfeld',
    ...
    ingo:'Jan ist für Überraschungen gut, besonders wenn irgendwo ein Bayern-Spieler auftaucht. Der aktuelle Kader ist vernünftig, aber noch nicht furchteinflößend.',
    werner:'Die Mannschaft ist ausgeglichen, jedoch ohne echte Spitzenwerte. Der nächste Transfer wird entscheidender sein als der aktuelle Marktwert.',
    franz:'BANGKOK-BAYERN-BÖRSE! Jan wartet nur auf den nächsten roten Namen.'
  },
  {
    name:'Sebastian', team:'DieseHaine', profileTitle:'Der Laptoptrainer', claim:'Zwischen Tabellenkalkulation und Meisterschale.', image:'/images/managers/sebastian.png', profileText:'Rekordmeister, Transfergenie und gelegentlicher Wahnsinniger. Sebastian analysiert vom Laptop aus, verbrennt dabei gern Praktikanten und ist seit Bratislava 2019 auch als Rapper Pink Panther bekannt.', runningGag:'„Mir fehlt noch etwas die Motivation …“ – der Satz, nach dem meistens alle anderen nervös werden.', rank:8, value:'20,07 Mio.', grade:'2,7', verdict:'Nie abschreiben',
    ...
    ingo:'Der Rekordmeister wirkt verwundbar. Genau in solchen Momenten sollte man bei Sebastian besonders vorsichtig sein.',
    werner:'Stand heute ist das kein Meisterkader. Historische Leistung und Transferkompetenz verhindern dennoch eine schlechtere Prognose.',
    franz:'MOTIVATION VERMISST! Sebastian startet mit Gnabry, drei Fragezeichen und seinem berühmtesten Satz.'
  },
  {
    name:'Greg', team:'Griesgram1', profileTitle:'Der Dino', claim:'Mehr Abenteuer als Abseitsregel – und genau deshalb Kult.', image:'/images/managers/greg.png', profileText:'Greg gehört gemeinsam mit Wassilios zu den IWF-Dinosauriern. Er liebt Geschwindigkeit und Höhe, besitzt überschaubares Fußballwissen und landet trotzdem immer wieder unerklärliche Transfercoups.', runningGag:'Je weniger logisch ein Transfer wirkt, desto größer ist Gregs Chance, damit recht zu behalten.', rank:9, value:'23,48 Mio.', grade:'3,0', verdict:'Transfercoup nötig',
  ...
  },
  {
    ...
    ingo:'Wassilios’ größter Gegner ist nicht die Konkurrenz, sondern die Zeit. Der Kader braucht Aufmerksamkeit – und noch einige Einkäufe.',
    werner:'Der aktuelle Kader weist die niedrigste Dichte an sicheren Punktespielern auf. Rang zehn ist deshalb sachlich begründet.',
    franz:'TRAINER OHNE TEAM? Wassilios hat Geld, Reitz und sehr viel Arbeit.'
  }
]
