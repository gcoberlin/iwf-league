...
function Header() {
  return <>
    ...
    <div className="magBreaking"><b>🔥 BREAKING</b><div className="tickerViewport"><span>VOR SPIELTAG 2: José führt mit 69 · Luca 57 · Greg 45 · Sebastian 41 · Transfermarkt in Bewegung ·</span></div></div>
  </>
}
